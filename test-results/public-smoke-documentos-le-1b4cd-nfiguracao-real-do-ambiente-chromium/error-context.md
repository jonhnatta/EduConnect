...
- Name: public-smoke.spec.ts >> documentos legais usam configuracao real do ambiente
- Location: e2e/public-smoke.spec.ts:23:1

# Error details

```
Error: /privacidade deve responder 2xx
